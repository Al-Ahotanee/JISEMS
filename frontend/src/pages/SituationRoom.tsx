          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="hidden sm:inline-block text-xs font-mono font-semibold px-2 py-0.5 rounded bg-primary-50 text-primary-700 border border-primary-200">
                  ...
                  <div className="text-xl sm:text-2xl font-display font-bold text-text-primary flex flex-wrap items-baseline gap-2">
                    ...
                    <span className="text-text-muted text-base font-mono font-normal">
                      {selectedLgaId && lgaDetail?.wards ? (
                        ...
                        <>• {room.reported_lgas || 0} of {room.total_lgas || 11} LGAs Reporting</>
                      )}
                    </span>
                  </div>
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    {room.available_elections.map((elec: any) => {
                      ...
                      return (
                        ...
                        >
                          <span>
                            {elec.election_type === 'gubernatorial' ? '🗳️ Gubernatorial' :
                             elec.election_type === 'senatorial' ? '🏛️ Senate' :
                             elec.election_type === 'house_of_representatives' ? '🏛️ Reps' : '🏛️ Assembly'}
                          </span>
                ...
                <div>
                  ...
                  <h2 className="font-display text-2xl sm:text-3xl font-semibold tracking-tight text-text-primary flex items-center gap-3">
                    ...
                    {(selectedLgaId || selectedWardId) && (
                      ...
                      >
                        {selectedWardId ? 'Back to LGA Wards ✕' : 'Clear Filter ✕'}
                      </button>
                    )}
                  </h2>
