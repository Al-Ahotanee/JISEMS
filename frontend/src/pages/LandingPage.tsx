  ...
  return (
    <Link to="/" className="flex items-center gap-3" aria-label="JISEMS home">
      ...
      <span>
        ...
        <span className="mt-1 block text-[.56rem] font-extrabold uppercase tracking-[.16em] text-text-muted">Jigawa State Election Monitor</span>
      </span>
    </Link>
  );
}
        ...
        <section className="relative isolate overflow-hidden pb-20 pt-36 sm:pb-28 sm:pt-44">
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-14 px-5 sm:px-8 lg:grid-cols-[1fr_.92fr] lg:gap-20">
            <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .65 }}>
              ...
              <p className="mt-7 max-w-xl text-lg leading-8 text-text-secondary sm:text-xl">JISEMS is the operating map for transparent election monitoring across Jigawa State—connecting field evidence, review workflows, collation, and public visibility.</p>
              ...
              <div className="mt-8 flex flex-wrap gap-x-6 gap-y-3 text-xs font-bold text-text-muted"><span className="inline-flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-accent-600"/> Evidence-led workflows</span><span className="inline-flex items-center gap-2"><LockKeyhole className="h-4 w-4 text-primary-600"/> Role-based access</span><span className="inline-flex items-center gap-2"><Globe2 className="h-4 w-4 text-status-warning"/> Built for Jigawa</span></div>
            </motion.div>
